...
| [PRE-C1-B](./PRE-C1-B-outlier-strategy.md) | Fit Mode Outlier Strategy Decision | Pre-Start | 0.5 day |
...
2. PRE-C1-B — Outlier Strategy Decision
...
|------|---------|----------|
| Pre-Start complete | After PRE-C1-A, B, C | Label spike proves chosen algorithm works on worst-case mock. **PRE-C1-A done:** Spatial Bin selected ([decision](./PRE-C1-A-label-collision-spike.md#label-collision-algorithm-decision-completed)). Proceed to C1 after B and C. |
