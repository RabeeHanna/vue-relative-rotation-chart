...
|------|-------|-------|------|
| [PRE-C1-A](./PRE-C1-A-label-collision-spike.md) | Label Collision Algorithm Spike | Pre-Start | 1 day |
...
1. PRE-C1-A — Label Collision Spike
...
|------|---------|----------|
| Pre-Start complete | After PRE-C1-A, B, C | Label spike proves chosen algorithm works on worst-case mock. Proceed to C1. |
