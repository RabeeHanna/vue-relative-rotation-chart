...
| [C22](./C22-mobile-playback-polish.md) | Mobile Playback Polish (**complete**) | Interaction / Polish | 1–2 days |
...
| [C29](./C29-standalone-host-decoupling.md) | Standalone host decoupling — scrub Sector Orbit references from public surfaces (**ready**) | Packaging / Trust | 0.5–1 day |
...
25. C22 — Mobile playback polish (`RrgPlaybackControls` touch/layout) (**complete** — [plan](./C22-mobile-playback-polish.md))
...
28. C29 — Standalone host decoupling: scrub Sector Orbit branding from README, demo shell, docs, and tighten public-surface scrub test (**next** — [plan](./C29-standalone-host-decoupling.md))
29. C10 — Host feature-flag integration (**optional dogfood / recipe**; merge to host default branch not required for publish)
